...
const Copyright = () => {
    ...
    const socialLinks = [
        { icon: <FacebookFilled />, url: "https://facebook.com/AqibShabbir", color: "hover:text-blue-400" },
        { icon: <InstagramOutlined />, url: "https://instagram.com/aqibshabbir876", color: "hover:text-pink-400" },
        { icon: <WhatsAppOutlined />, url: "https://wa.me/923078244507", color: "hover:text-green-400" },
        { icon: <LinkedinOutlined />, url: "https://linkedin.com/in/AqibShabbir", color: "hover:text-blue-500" },
    ];
